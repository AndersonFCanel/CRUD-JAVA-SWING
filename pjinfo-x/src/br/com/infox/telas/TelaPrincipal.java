...
public class TelaPrincipal extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/br/com/infox/icones/if_x_8823 (1).png"))); // NOI18N

        lblUsuario.setFont(new java.awt.Font("Vrinda", 1, 24)); // NOI18N
        ...
        MenAjudaSob.setAccelerator(javax.swing.KeyStroke.getKeyStroke(java.awt.event.KeyEvent.VK_F1, java.awt.event.InputEvent.ALT_MASK));
        ...
        setSize(new java.awt.Dimension(915, 613));
        setLocationRelativeTo(null);
    }// </editor-fold>//GEN-END:initComponents

    private void MenCadCliActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_MenCadCliActionPerformed
//Chamando a tela de Cliente 
        TelaDeCLiente cliente = new TelaDeCLiente();
    ...
    private void MenCadUserActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_MenCadUserActionPerformed
        // As linhas abaixo abrirão o form TelaUsuario dentro da TelaPrincipal no desktop pane
        TelaDeUsuario usuario = new TelaDeUsuario();
    ...
    //TODA A VEZ QUE A JANELA FOR ATIVADA
    private void formWindowActivated(java.awt.event.WindowEvent evt) {//GEN-FIRST:event_formWindowActivated
        //as linhas abaixo substtuem a label lblData pela data atual do sistema
        Date data = new Date();
        DateFormat formatador = DateFormat.getDateInstance(DateFormat.SHORT);
        lblData.setText(formatador.format(data));
    }//GEN-LAST:event_formWindowActivated
    //Ao Clicar na opção sair no menu opções sair
